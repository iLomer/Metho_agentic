...
- **Token optimized** -- agent instructions and workflow files are deduplicated and concise, so Claude Code sessions consume fewer tokens and produce more useful output per dollar
