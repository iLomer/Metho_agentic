...
export function buildWorkflowAgentsSection(
  ...
  const swarmSection = [
    ...
    "",
    "**Critical rule:** The lead agent (you) orchestrates only -- NEVER implement tasks directly. Always delegate: `@meto-pm` for planning, `@meto-epic-[id]` for building, `@meto-tester` for validation.",
    "",
    "| Agent | Owns |",
    "|---|---|",
