...
const COLUMN_FILES: Record<(typeof COLUMNS)[number], string> & Record<string, string> = {
...
export async function moveTask(
  ...
  const sourceFile = COLUMN_FILES[fromColumn];
  const destFile = COLUMN_FILES[toColumn];
